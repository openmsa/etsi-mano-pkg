...
public interface AffinityRuleToscaMapping {
	...
	@Mapping(target = "anti", ignore = true)
	AffinityRule map(com.ubiqube.parser.tosca.objects.tosca.policies.nfv.AffinityRule ar);
	...
	@Mapping(target = "toscaId", ignore = true)
	@Mapping(target = "toscaName", source = "internalName")
	@Mapping(target = "anti", constant = "true")
	AffinityRule map(AntiAffinityRule aar);
}
